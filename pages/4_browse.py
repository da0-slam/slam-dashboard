...
`diggCount` → like_count · `commentCount` → comment_count · `shareCount` → share_count · `collectCount` → save_count
...
""")
        ...
        if _csv_bytes:
            try:
                ...
                _thumb_col = _fc(["thumbnail_url", "videometa_coverurl", "videometa_coverimage", "displayurl", "images_0", "cover", "authormeta.avatar", "authormeta_avatar", "avatar"])
