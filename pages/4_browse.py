...
""")
        ...
        if _csv_bytes:
            try:
                ...
                _play_col  = _fc(["videoplaycount", "playcount", "play_count"])
                ...
                _date_col  = _fc(["createtimeiso", "createtime", "timestamp", "posted_at"])
                _thumb_col = _fc(["thumbnail_url", "authormeta_avatar", "displayurl", "avatar", "cover"])
