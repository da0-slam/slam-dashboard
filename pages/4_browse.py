...
""")
        ...
        if _csv_bytes:
            try:
                ...
                _id_col    = _fc(["authormeta_name", "author_name", "influencer_id", "ownerusername", "username"])
                ...
                _thumb_col = _fc(["thumbnail_url", "displayurl", "images_0", "authormeta_avatar", "avatar", "cover"])
